...
public class ItemAssistant {
    ...
    public void dropAllItems() {
        ...
        if (c.playerRights == 6/*|| c.isInArd() || c.isInFala()*/) {
            return;
        }
        for (int i = 0; i < c.playerItems.length; i++) {
            if (o != null) {
    ...
    public void getRequirements(String itemName, int itemId) {
        ...
        switch (itemId) {
            ...
            case 9813://quest cape
                ...
                c.slayerLevelReq = 99;
                c.summoningLevelReq = 99;
                c.miningLevelReq = 99;
                c.smithingLevelReq = 99;
                c.fishingLevelReq = 99;
                c.cookingLevelReq = 99;
                c.firemakingLevelReq = 99;
                c.woodcuttingLevelReq = 99;
    ...
    public boolean wearItem(int wearID, int slot) {
        synchronized (c) {
            ...
            if (c.playerItems[slot] == (wearID + 1)) {
                ...
                switch (wearID) {
                    case 18510://Dung hood
                        targetSlot = 0;
                        break;
                }
                switch (wearID) {
                    case 13672://Ringmaster Hat
                        targetSlot = 0;
                        break;
                }
                switch (wearID) {
                    case 13673://Ringmaster Body
                        targetSlot = 4;
                        break;
                }
                switch (wearID) {
                    case 13674://Ringmaster legs
                        targetSlot = 7;
                        break;
                }
