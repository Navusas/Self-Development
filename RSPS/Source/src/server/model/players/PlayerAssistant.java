...
public class PlayerAssistant {
    ...
    public void loadAnnouncements() {
        try {
            ...
            if (p.getProperty("announcement5").length() > 0) {
                c.sendMessage(p.getProperty("announcement5"));
            }
    ...
    public void giveLife() {
        ...
        if (c.duelStatus <= 4 && !c.getPA().inPitsWait()) { // if we are not in a duel we must be in wildy so remove items
            if (!c.inPits && !c.inFightCaves() && !c.inPcGame() && !c.inFunPk()) {
    ...
    public void checkIfMaxedLevel(int skill) {
        String SKILLS_IN_STRING[] = {"attack", "defence", "strength", "hitpoints", "range", "prayer", "magic", "cooking"
        ...
        if (getLevelForXP((c.playerXP[skill])) == 99) {
            for (Player player : PlayerHandler.players) {
                Misc.println("Player is in array: " + player);
                if (player != null && player.isActive) {
                    ((Client) player).sendAchieved99_Message("Player " + c.playerName +
                            " achieved 99 in " + SKILLS_IN_STRING[skill]);
                }
            }
        }
    }
    ...
    public void levelUp(int skill) {
        /*Update total level after levelling up */
        updateTotalLevel();

        /*Check if user reached maximum level possible in specific skill*/
        checkIfMaxedLevel(skill);

        switch (skill) {
            case 0:
                sendFrame126("Congratulations, you just advanced an attack level!", 6248);
                sendFrame126("Your attack level is now " + getLevelForXP(c.playerXP[skill]) + ".", 6249);
                c.sendSystemMessage("Congratulations, you just advanced an attack level.");
            ...
            case 1:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a defence level.");
                c.getPA().sendFrame126("Combat Level: " + c.getCombatLevel() + "", 3983);
                sendFrame164(6253);
                break;
            ...
            case 2:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a strength level.");
                c.getPA().sendFrame126("Combat Level: " + c.getCombatLevel() + "", 3983);
                sendFrame164(6206);
                break;
            ...
            case 3:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a hitpoints level.");
                c.getPA().sendFrame126("Combat Level: " + c.getCombatLevel() + "", 3983);
                sendFrame164(6216);
                break;
            ...
            case 5:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a prayer level.");
                c.getPA().sendFrame126("Combat Level: " + c.getCombatLevel() + "", 3983);
                sendFrame164(6242);
                break;
            ...
            case 6:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a magic level.");
                c.getPA().sendFrame126("Combat Level: " + c.getCombatLevel() + "", 3983);
                sendFrame164(6211);
                break;
            ...
            case 7:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a cooking level.");
                sendFrame164(6226);
                break;
            ...
            case 8:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a woodcutting level.");
                sendFrame164(4272);
                break;
            ...
            case 9:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a fletching level.");
                sendFrame164(6231);
                break;
            ...
            case 10:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a fishing level.");
                sendFrame164(6258);
                break;
            ...
            case 11:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a fire making level.");
                sendFrame164(4282);
                break;
            ...
            case 12:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a crafting level.");
                sendFrame164(6263);
                break;
            ...
            case 13:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a smithing level.");
                sendFrame164(6221);
                break;
            ...
            case 14:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a mining level.");
                sendFrame164(4416);
                break;
            ...
            case 15:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a herblore level.");
                sendFrame164(6237);
                break;
            ...
            case 16:
                ...
                c.sendSystemMessage("Congratulations, you just advanced an agility level.");
                sendFrame164(4277);
                break;
            ...
            case 17:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a thieving level.");
                sendFrame164(4261);
                break;
            ...
            case 18:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a slayer level.");
                sendFrame164(12122);
                break;
            ...
            case 20:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a runecrafting level.");
                sendFrame164(4267);
                break;
            ...
            case 21:
                ...
                c.sendSystemMessage("Your hunter level is now " + getLevelForXP(c.playerXP[skill]) + ".");
                break;
            ...
            case 22:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a Summoning level.");
                sendFrame164(4267);
                break;
            ...
            case 23:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a PK'ing level.");
                sendFrame164(12122);
                break;
            ...
            case 24:
                ...
                c.sendSystemMessage("Congratulations, you just advanced a Dungeoneering level.");
                sendFrame164(12122);
                break;
        }
        c.dialogueAction = 0;
    ...
    public void refreshSkill(int i) {
        switch (i) {
            case 0:
                sendFrame126("" + c.playerLevel[0] + "", 7159);
                sendFrame126("" + getLevelForXP(c.playerXP[0]) + "", 7160);

                break;

            case 1:
                sendFrame126("" + c.playerLevel[1] + "", 7163);
                sendFrame126("" + getLevelForXP(c.playerXP[1]) + "", 7164);

                break;

            case 2:
                sendFrame126("" + c.playerLevel[2] + "", 7161);
                sendFrame126("" + getLevelForXP(c.playerXP[2]) + "", 7162);

                break;

            case 3:
                sendFrame126("" + c.playerLevel[3] + "", 7175);
                sendFrame126("" + getLevelForXP(c.playerXP[3]) + "", 7176);

                break;

            case 4:
                sendFrame126("" + c.playerLevel[4] + "", 7165);
                sendFrame126("" + getLevelForXP(c.playerXP[4]) + "", 7166);

                break;
            //7159 7163 7161 7175 7165 7167 7169 7197 7201 7185 7195 7199 7183 7193 7191 7179 7177 7181 7187 7203 7171 7173 7189 7205 7157
            case 5:
                sendFrame126("" + c.playerLevel[5] + "", 7167);
                sendFrame126("" + getLevelForXP(c.playerXP[5]) + "", 7168);

                sendFrame126("" + c.playerLevel[5] + "/" + getLevelForXP(c.playerXP[5]) + "", 687);//Prayer frame
                break;

            case 6:
                sendFrame126("" + c.playerLevel[6] + "", 7169);
                sendFrame126("" + getLevelForXP(c.playerXP[6]) + "", 7170);

                break;

            case 7:
                sendFrame126("" + c.playerLevel[7] + "", 7197);
                sendFrame126("" + getLevelForXP(c.playerXP[7]) + "", 7198);

                break;

            case 8:
                sendFrame126("" + c.playerLevel[8] + "", 7201);
                sendFrame126("" + getLevelForXP(c.playerXP[8]) + "", 7202);

                break;

            case 9:
                sendFrame126("" + c.playerLevel[9] + "", 7185);
                sendFrame126("" + getLevelForXP(c.playerXP[9]) + "", 7186);

                break;

            case 10:
                sendFrame126("" + c.playerLevel[10] + "", 7195);
                sendFrame126("" + getLevelForXP(c.playerXP[10]) + "", 7196);

                break;

            case 11:
                sendFrame126("" + c.playerLevel[11] + "", 7199);
                sendFrame126("" + getLevelForXP(c.playerXP[11]) + "", 7200);

                break;

            case 12:
                sendFrame126("" + c.playerLevel[12] + "", 7183);
                sendFrame126("" + getLevelForXP(c.playerXP[12]) + "", 7184);

                break;

            case 13:
                sendFrame126("" + c.playerLevel[13] + "", 7193);
                sendFrame126("" + getLevelForXP(c.playerXP[13]) + "", 7194);

                break;

            case 14:
                sendFrame126("" + c.playerLevel[14] + "", 7191);
                sendFrame126("" + getLevelForXP(c.playerXP[14]) + "", 7192);

                break;

            case 15:
                sendFrame126("" + c.playerLevel[15] + "", 7179);
                sendFrame126("" + getLevelForXP(c.playerXP[15]) + "", 7180);

                break;
            //7177 7181 7187 7203 7171 7173 7189 7205 7157
            case 16:
                sendFrame126("" + c.playerLevel[16] + "", 7177);
                sendFrame126("" + getLevelForXP(c.playerXP[16]) + "", 7178);

                break;

            case 17:
                sendFrame126("" + c.playerLevel[17] + "", 7181);
                sendFrame126("" + getLevelForXP(c.playerXP[17]) + "", 7182);

                break;

            case 18:
                sendFrame126("" + c.playerLevel[18] + "", 7187);
                sendFrame126("" + getLevelForXP(c.playerXP[18]) + "", 7188);

                break;

            case 19:
                sendFrame126("" + c.playerLevel[19] + "", 7203);
                sendFrame126("" + getLevelForXP(c.playerXP[19]) + "", 7204);

                break;

            case 20:
                sendFrame126("" + c.playerLevel[20] + "", 7171);
                sendFrame126("" + getLevelForXP(c.playerXP[20]) + "", 7172);
                break;

            case 21:
                sendFrame126("" + c.playerLevel[21] + "", 7173);
                sendFrame126("" + getLevelForXP(c.playerXP[21]) + "", 7174);

                break;

            case 22:
                sendFrame126("" + c.playerLevel[22] + "", 7189);
                sendFrame126("" + getLevelForXP(c.playerXP[22]) + "", 7190);

                break;

            case 23:
                sendFrame126("" + c.playerLevel[23] + "", 7205);
                sendFrame126("" + getLevelForXP(c.playerXP[23]) + "", 7206);

                break;

            case 24:
                sendFrame126("" + c.playerLevel[24] + "", 7157);
                sendFrame126("" + getLevelForXP(c.playerXP[24]) + "", 7158);
                break;
        }
    }
    ...
    public void totallevelsupdate() {
        ...
        sendFrame126("@whi@Total Level: " + totalLevel, 7127
        );
    }

    public void updateLevelingPoints(int amount) {
        c.levelingPoints += amount;
    }

    public boolean addSkillXP(int amount, int skill) {

        int oldLevel = getLevelForXP(c.playerXP[skill]); // have old level for levelling up points sum up
        if (c.xpLock || c.Jail) {
            return false;
        }
        ...
        /*
        if user is donator AND is wearing donator cape, it gets experience bonus
        */
        if (c.isDonator == 1 && c.playerEquipment[c.playerCape] == 901) {
            amount *= (Config.SERVER_EXP_BONUS * Config.DONATOR_CAPE_BONUS);
        } else {
            amount *= Config.SERVER_EXP_BONUS;
        }

        c.playerXP[skill] += amount; // add experience to current skill

        if (oldLevel < getLevelForXP(c.playerXP[skill])) { // make sure current level is higher then it was before
            if (c.playerLevel[skill] < c.getLevelForXP(c.playerXP[skill]) && skill != 3 && skill != 5)
                c.playerLevel[skill] = c.getLevelForXP(c.playerXP[skill]);
            levelUp(skill); // update level
            c.gfx100(199);
            requestUpdates();
            updateLevelingPoints(getLevelForXP(c.playerXP[skill]) - oldLevel); // update levelling up points
        }
    ...
    public static int Cracker[] = {1038, 1040, 1042, 1044, 1046, 1048};
    ...
    public static int ChestRewards[] = {1359, 1275, 1333, 1079, 1127, 1163, 4131, 1201, 1319};
    ...
    public void removeFromCW() {
        if (c.castleWarsTeam == 1) {
            if (c.inCwWait) {
                Server.castleWars.saradominWait.remove(c.playerId);
            } else {
                Server.castleWars.saradomin.remove(c.playerId);
            }
        } else if (c.castleWarsTeam == 2) {
            if (c.inCwWait) {
                Server.castleWars.zamorakWait.remove(c.playerId);
            } else {
                Server.castleWars.zamorak.remove(c.playerId);
            }
        }
    }
    ...
    public void addStarter() {
        if (!Connection.hasRecieved1stStarter(Server.playerHandler.players[c.playerId].connectedFrom)) {
            ...
            c.receive = 1;
            c.trade11 = 900;
            c.getItems().addItem(995, 14000000);
        ...
        if (c.receive != 1 && !Connection.hasRecieved2ndStarter(Server.playerHandler.players[c.playerId].connectedFrom)) {
    ...
    public void enterRFD() {
        ...
        if (c.Agrith && !c.Flambeed) {
            c.waveId = 1;
            c.getPA().movePlayer(1899, 5363, c.playerId * 4 + 2);
            Server.rfd.spawnNextWave(c);
            return;
        }
        if (c.Flambeed && !c.Karamel) {
            c.waveId = 2;
            c.getPA().movePlayer(1899, 5363, c.playerId * 4 + 2);
            Server.rfd.spawnNextWave(c);
            return;
        }
        if (c.Karamel && !c.Dessourt) {
            c.waveId = 3;
            c.getPA().movePlayer(1899, 5363, c.playerId * 4 + 2);
            Server.rfd.spawnNextWave(c);
            return;
        }
        if (c.Dessourt && !c.Culin) {
            c.waveId = 4;
            c.getPA().movePlayer(1899, 5363, c.playerId * 4 + 2);
            Server.rfd.spawnNextWave(c);
            return;
    ...
    public void handleLoginText() {
        ...
        c.getPA().sendFrame126("Various Monster Teleport", 1301);
        c.getPA().sendFrame126("Monster Teleport", 13037);
        c.getPA().sendFrame126("Various Monster Teleport", 13038);

        c.getPA().sendFrame126("Minigame Teleport", 1325);
        c.getPA().sendFrame126("Various Minigame Teleport", 1326);
        c.getPA().sendFrame126("Minigame Teleport", 13047);
        c.getPA().sendFrame126("Various Minigame Teleport", 13048);

        c.getPA().sendFrame126("Bosses Teleport", 1350);
        c.getPA().sendFrame126("Various Bosses Teleport", 1351);
        c.getPA().sendFrame126("Bosses Teleport", 13055);
        c.getPA().sendFrame126("Various Bosses Teleport", 13056);

        c.getPA().sendFrame126("Pking Teleport", 1382);
        c.getPA().sendFrame126("Various Pking Teleport", 1383);
        c.getPA().sendFrame126("Pking Teleport", 13063);
        c.getPA().sendFrame126("Various Pking Teleport", 13064);

        c.getPA().sendFrame126("Skill Teleport", 1415);
        c.getPA().sendFrame126("Skilling Zone", 1416);
        c.getPA().sendFrame126("Skill Teleport", 13071);
        c.getPA().sendFrame126("Skilling Zone", 13072);

        c.getPA().sendFrame126("City Teleport", 1454);
        c.getPA().sendFrame126("Various City Teleport", 1455);
        c.getPA().sendFrame126("City Teleport", 13081);
        c.getPA().sendFrame126("Various City Teleport", 13082);

        c.getPA().sendFrame126("Advanced Skilling", 7457);
        c.getPA().sendFrame126("Various Skill Teleport", 7458);
        c.getPA().sendFrame126("Advanced Skilling", 13089);
        c.getPA().sendFrame126("Various Skill Teleport", 13090);

        c.getPA().sendFrame126("Advanced Bosses", 18472);
        c.getPA().sendFrame126("Various Bosses Teleport", 18473);
    }
