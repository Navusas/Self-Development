    ...
    public void playerCommands(Client c, String playerCommand) {
        ...
        if (playerCommand.startsWith("commands")) {
            /*for(int i = 0; i < 1000000; i+= 3) {
                c.sendMessage("<col="+i+"> " + i + " This is the color you may would like to see. LOOOOL ");
            }*/
            c.sendMessage( "<col=f86bfb> Commands Available");
            c.sendMessage( "<col=16711680>::changepassword</shad> *newpasswordhere* changes your password");
            c.sendMessage( "<col=4>::changepassword</shad> *newpasswordhere* changes your password");
        ...
        if (playerCommand.startsWith("yell")) {
            ...
            else if(playerCommand.length() <= 5) { // avoid NullPointerException if no string given
                return;
            }
            for (int j = 0; j < Server.playerHandler.players.length; j++) {
                if (Server.playerHandler.players[j] != null) {
                    ...
                    switch (c.playerRights) {
                        case 0: // simple player
                            c.sendMessage("<col="+SubstringColors.RED_LIGHT+">You must be a donator+ to use this command!</col>");
                            break;
                        case 1: // Moderator
                            c2.sendMessage("<col="+SubstringColors.WHITE+">[<img=1>" + Misc.optimizeText(c.playerName) + "] :</col> "
                                    + Misc.optimizeText(playerCommand.substring(5)) + "");
                            break;
                        case 2: // Administrator
                            c2.sendMessage("<col="+SubstringColors.BLUE_LIGHT+">[<img=2>" + Misc.optimizeText(c.playerName) + "] :</col> "
                                    + Misc.optimizeText(playerCommand.substring(5)) + "");
                            break;
                        case 3: // Co Owner
                            c2.sendMessage("<col="+SubstringColors.YELLOW_LIGHT+">[<img=6>" + Misc.optimizeText(c.playerName) + "] :</col> "
                                    + Misc.optimizeText(playerCommand.substring(5)) + "");
                            break;
                        case 4: // Donator
                            c2.sendMessage("<col="+SubstringColors.RED+">[<img=0>" + Misc.optimizeText(c.playerName) + "] :</col> "
                                    + Misc.optimizeText(playerCommand.substring(5)) + "");
                            break;
                        case 5: // Sponsor
                            ...
                            break;
                        case 6: // Main Owner
                            c2.sendMessage("[<img=6>" + Misc.optimizeText(c.playerName) + "] : "
                                    + Misc.optimizeText(playerCommand.substring(5)) + "", SubstringColors.YELLOW);
                            break;
                        case 7: // V.I.P
