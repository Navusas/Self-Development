...
public class ItemClick3 implements PacketType {
    ...
    public void processPacket(Client c, int packetType, int packetSize) {
        ...
        switch (itemId) {
            ...
            case 5733: //STAFF POTATO
                if (c.playerRights == 2 || c.playerRights == 3 || c.playerRights == 6) {
                    c.sendMessage("Select which option you wanna do!");
                    c.getPA().showInterface(5000);
                } else {
                    c.sendMessage("You must be an administrator+ to open this interface.");
                    c.sendMessage("Please tell an owner how did you get this powerful potato!");
                    return;
                }
                break;
