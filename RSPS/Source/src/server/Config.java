...
public class Config {
    ...
    public static final int IPS_ALLOWED = 200; // how many ips are allowed
    ...
    public static final int[] UNDROPPABLE_ITEMS = {5733, 897, 899, 900, 901, 902, 903, 904, 18509, 15808, 15914, 15925, 15936, 16013, 16035, 16127, 16262, 19893, 19892, 15786, 15797, 15837, 15892, 16185, 16153, 16002, 16046, 16057, 16068, 16105, 15308, 18328, 18312, 18296, 18280, 15312, 15316, 15320, 15324, 12470, 12472, 12474}; // what items can't be dropped
    ...
    public static final boolean ADMIN_CAN_PK = false;
    public static final boolean ADMIN_CAN_DROP = false;
    ...
    public static final int SKULL_TIMER = 2000; // how long does the skull last? seconds x 2
     ...
     */
    public static final int MELEE_EXP_RATE = 9500; // damage * exp rate
    public static final int RANGE_EXP_RATE = 9500;
    public static final int MAGIC_EXP_RATE = 9500;
    public static final int WOODCUTTING_EXPERIENCE = 555555555;
    public static final int MINING_EXPERIENCE = 555555555;
    public static final int SMITHING_EXPERIENCE = 635;
    public static final int FARMING_EXPERIENCE = 1830;
    public static final int FIREMAKING_EXPERIENCE = 555555555;
    public static final int HERBLORE_EXPERIENCE = 535;
    public static final int FISHING_EXPERIENCE = 635;
    public static final int AGILITY_EXPERIENCE = 670;
    public static final int PRAYER_EXPERIENCE = 555555555;
    public static final int RUNECRAFTING_EXPERIENCE = 550;
    public static final int CRAFTING_EXPERIENCE = 740;
    public static final int THIEVING_EXPERIENCE = 555555555;
    public static final int SLAYER_EXPERIENCE = 540;
    public static final int COOKING_EXPERIENCE = 530;
    public static final int FLETCHING_EXPERIENCE = 735;


    /*
    * Other items experience bonus
    * */
    public static final double DONATOR_CAPE_BONUS = 1.5;
}
